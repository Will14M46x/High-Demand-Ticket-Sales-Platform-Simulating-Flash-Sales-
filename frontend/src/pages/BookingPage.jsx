...
function BookingPage() {
    ...
    useEffect(() => {
        ...
        if (timeRemaining > 0 && !success) {
            ...
            setError('Time expired. Your ticket hold was released. Redirecting...')
            // We don't need to do anything, the backend will handle the expired hold
            setTimeout(() => navigate(`/events/${eventId}`), 3000)
        }
    }, [timeRemaining, success, eventId, navigate])
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Our backend booking-service handles inventory reservation.
            // We pass the eventId and quantity. The backend gets the userId from our token.
            const bookingData = {
            ...
            // Step 2: Simulate payment processing (this is a mock)
            // This is just to make the UI look real
            await new Promise(resolve => setTimeout(resolve, 2000))

            // Step 3: Confirm the booking (and mock payment)
            // This tells our backend to change the status from PENDING to PAID
            await bookingAPI.confirmBooking(bookingResponse.orderId);
            ...
            // Handle errors (e.g., "Not admitted", "Not enough stock")
                            ...
                            <>
                                <div className="bg-gradient-to-br from-primary-400 to-primary-600 rounded-lg p-4 mb-6 text-white">
                                    ...
                                    <p className="text-sm opacity-90">
                                        {format(new Date(event.saleStartTime), 'PPP p')}
                                    </p>
                                ...
                                <div className="space-y-3 mb-6">
                                    ...
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="font-medium">${event.price ? event.price.toFixed(2) : '0.00'}</span>
                                    </div>
