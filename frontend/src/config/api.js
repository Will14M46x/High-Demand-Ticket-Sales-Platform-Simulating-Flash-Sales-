...
export const API_ENDPOINTS = {
  ...
  RESERVE_TICKETS: (eventId, quantity) => `${API_BASE_URLS.INVENTORY}/reserve/${eventId}?quantity=${quantity}`,
  
  // Waiting Room endpoints
  JOIN_QUEUE: `${API_BASE_URLS.WAITING_ROOM}/join`,
  QUEUE_STATUS: `${API_BASE_URLS.WAITING_ROOM}/status`,
  LEAVE_QUEUE: `${API_BASE_URLS.WAITING_ROOM}/leave`,
  
  // Booking endpoints
  CREATE_BOOKING: `${API_BASE_URLS.BOOKING}`,
  GET_BOOKINGS: `${API_BASE_URLS.BOOKING}/user`,
