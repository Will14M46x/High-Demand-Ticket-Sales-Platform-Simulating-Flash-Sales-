package com.ticketsale.waiting_room_service.service; // <-- New package

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.springframework.data.redis.core.RedisTemplate;
import org.springframework.stereotype.Service;
// New import path for your DTO
...
public class WaitingRoomService {
        ...
        try {
            ...
            if (rank == null) {
                ...
                if (Boolean.TRUE.equals(isAdmitted)) {
                    ...
                    return 0; // 0 means "admitted"
                }
                log.warn("User {} not found in queue for event {}", userId, eventId);
                return null;
            }
            return rank.intValue() + 1; // Position 1, 2, 3...
        } catch (Exception e) {
    ...
    public QueueStatusResponse getQueueStatus(Long eventId) {
        try {
            ...
            String estimatedWait = (waiting * 30L) + " seconds"; // Simple estimation
