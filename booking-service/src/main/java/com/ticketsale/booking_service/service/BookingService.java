...
public class BookingService {
    ...
    public OrderResponse createBooking(BookingRequest request) {
        ...
        try {
            ...
            ResponseEntity<String> response = restTemplate.exchange(reserveUrl, org.springframework.http.HttpMethod.PUT,null, String.class);
    ...
    private void releaseTicketsInInventory(Long eventId, int quantity) {
        ...
        try {
            ...
            restTemplate.exchange(releaseUrl, org.springframework.http.HttpMethod.PUT, null, String.class);
